...
#include <xinu.h>
#ifndef main
#define N 11 // Note: N must be <= NALOCKS 
#define ACTIVE  TRUE
#define TRY     FALSE
...
process	main(void)
{
	...
	/* varing priorities */
	pid[6] = create((void *)p2, INITSTK, 3, "p2", 3, &mutex[6], &mutex[7], TRY);
	pid[7] = create((void *)p2, INITSTK, 4, "p2", 3, &mutex[7], &mutex[8], TRY);
    pid[8] = create((void *)p2, INITSTK, 5, "p2", 3, &mutex[8], &mutex[9], TRY);
	pid[9] = create((void *)p2, INITSTK, 6, "p2", 3, &mutex[9], &mutex[10], TRY);
	pid[10] = create((void *)p2, INITSTK, 7, "p2", 3, &mutex[10], &mutex[11], TRY);
    pid[11] = create((void *)p2, INITSTK, 8, "p2", 3, &mutex[11], &mutex[6], TRY);
