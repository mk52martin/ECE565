...
/*------------------------------------------------------------------------
 *  create  -  Create a system process to start running a function on x86
 *------------------------------------------------------------------------
 */
pid32	create(
	...
	)
{
	...
	prptr->user_process = SYSTEM_PROCESS;
	...
	)
{
	...
	prptr->prparent = (pid32)getpid();
	prptr->prhasmsg = FALSE;
	prptr->user_process = USER_PROCESS;
